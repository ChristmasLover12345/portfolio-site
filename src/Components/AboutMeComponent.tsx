    ...
    <div className="w-full py-12 flex flex-col items-center gap-12">
      ...
      >
        ...
        <p className="text-lg text-white/80 leading-relaxed">
          I'm Juan Heredia, a bilingual (English & Spanish) Full Stack Developer passionate
          about building modern, scalable web applications. I love learning and pushing
          the limits of what's possible with code. My favorite tools include React, C#, SQL,
          and Tailwind CSS — and I’m always eager to contribute to impactful projects. (THIS IS FILLER, REPLASE LAter)
        </p>
      </motion.div>
